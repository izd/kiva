...
public class ScribeRequestAdapter implements OAuthBaseRequest {
    ...
    public void addQuerystringParameter(String key, String value) {
        ...
        if (key.equals(OAuthConstants.ACCESS_TOKEN)) {
            addQuerystringParameter(OAuthConstants.TOKEN, value);
        }
    ...
    public ParameterList getBodyParams() {
        if (getVerb() == Verb.GET || getVerb() == Verb.DELETE) {
            return new ParameterList();
        } else {
            return parseEntityParams();
        }
    }
